...
export interface Settings_pageD28 { id: string; name: string; value: number; ts: number; }

export interface Settings_pageD38 { id: string; name: string; value: number; ts: number; }
...
export interface About_pageD8 { id: string; name: string; value: number; ts: number; }
...
export interface Notification_centerD28 { id: string; name: string; value: number; ts: number; }
...
export interface Admin_panelD18 { id: string; name: string; value: number; ts: number; }
