...
interface MemoizationState { data: unknown; loading: boolean; error: string | null; initialized: boolean; }

export function useMemoization() {
  const [state, setState] = useState<MemoizationState>({ data: null, loading: false, error: null, initialized: false });
