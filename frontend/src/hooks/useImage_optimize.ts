...
interface Image_optimizeState { data: unknown; loading: boolean; error: string | null; initialized: boolean; }

export function useImage_optimize() {
  const [state, setState] = useState<Image_optimizeState>({ data: null, loading: false, error: null, initialized: false });
