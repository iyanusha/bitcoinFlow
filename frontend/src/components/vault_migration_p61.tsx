...
interface Vault_migrationP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP61({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP61Props) {
