...
interface Vault_migrationP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP0({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP0Props) {
