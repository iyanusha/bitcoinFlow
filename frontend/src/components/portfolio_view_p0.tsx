...
interface Portfolio_viewP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP0({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP0Props) {
