...
interface Vault_comparisonP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP31({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP31Props) {
