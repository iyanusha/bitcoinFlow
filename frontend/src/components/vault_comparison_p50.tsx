...
interface Vault_comparisonP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP50({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP50Props) {
