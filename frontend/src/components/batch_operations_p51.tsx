...
interface Batch_operationsP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Batch_operationsP51({ title = 'Add batch operation support', data, onAction }: Batch_operationsP51Props) {
