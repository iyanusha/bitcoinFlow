...
interface Network_statusP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP30({ title = 'Add network status monitor', data, onAction }: Network_statusP30Props) {
