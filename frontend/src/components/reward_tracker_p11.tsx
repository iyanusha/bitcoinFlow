...
interface Reward_trackerP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP11({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP11Props) {
