...
interface Stake_optimizerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP0({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP0Props) {
