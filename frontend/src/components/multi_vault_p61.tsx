...
interface Multi_vaultP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP61({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP61Props) {
