interface Vault_status_hooksItemProps { title: string; value: string; description?: string; }

export function Vault_status_hooksItem({ title, value, description }: Vault_status_hooksItemProps) {
  return (
