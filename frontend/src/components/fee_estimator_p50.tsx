...
interface Fee_estimatorP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP50({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP50Props) {
