...
interface Stx_converterP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP0({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP0Props) {
