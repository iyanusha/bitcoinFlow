...
interface Multi_vaultP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP1({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP1Props) {
