...
interface Reward_trackerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP0({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP0Props) {
