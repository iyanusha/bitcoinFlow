...
interface Vault_migrationP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP1({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP1Props) {
