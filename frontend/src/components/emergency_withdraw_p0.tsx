...
interface Emergency_withdrawP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP0({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP0Props) {
