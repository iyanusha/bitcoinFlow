interface Keyboard_shortcutsItemProps { title: string; value: string; description?: string; }

export function Keyboard_shortcutsItem({ title, value, description }: Keyboard_shortcutsItemProps) {
  return (
