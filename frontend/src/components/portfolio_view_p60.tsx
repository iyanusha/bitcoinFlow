...
interface Portfolio_viewP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP60({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP60Props) {
