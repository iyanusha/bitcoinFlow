...
interface Reward_trackerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP10({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP10Props) {
