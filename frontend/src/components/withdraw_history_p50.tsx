...
interface Withdraw_historyP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP50({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP50Props) {
