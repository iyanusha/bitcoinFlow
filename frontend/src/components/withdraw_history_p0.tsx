...
interface Withdraw_historyP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP0({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP0Props) {
