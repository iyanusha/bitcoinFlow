...
interface Block_explorer_linkP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Block_explorer_linkP41({ title = 'Add block explorer integration links', data, onAction }: Block_explorer_linkP41Props) {
