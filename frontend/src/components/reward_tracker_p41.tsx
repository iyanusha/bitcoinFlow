...
interface Reward_trackerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP41({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP41Props) {
