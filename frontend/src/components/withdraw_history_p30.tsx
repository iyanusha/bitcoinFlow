...
interface Withdraw_historyP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP30({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP30Props) {
