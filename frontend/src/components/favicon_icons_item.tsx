interface Favicon_iconsItemProps { title: string; value: string; description?: string; }

export function Favicon_iconsItem({ title, value, description }: Favicon_iconsItemProps) {
  return (
