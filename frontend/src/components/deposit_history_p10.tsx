...
interface Deposit_historyP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP10({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP10Props) {
