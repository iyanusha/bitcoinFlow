...
interface Portfolio_viewP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP40({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP40Props) {
