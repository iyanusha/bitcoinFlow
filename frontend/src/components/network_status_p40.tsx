...
interface Network_statusP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP40({ title = 'Add network status monitor', data, onAction }: Network_statusP40Props) {
