interface MemoizationItemProps { title: string; value: string; description?: string; }

export function MemoizationItem({ title, value, description }: MemoizationItemProps) {
  return (
