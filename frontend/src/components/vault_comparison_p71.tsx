...
interface Vault_comparisonP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP71({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP71Props) {
