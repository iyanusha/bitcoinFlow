interface Dark_mode_varsItemProps { title: string; value: string; description?: string; }

export function Dark_mode_varsItem({ title, value, description }: Dark_mode_varsItemProps) {
  return (
