...
interface Stake_optimizerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP60({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP60Props) {
