...
interface Stake_optimizerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP40({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP40Props) {
