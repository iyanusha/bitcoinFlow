...
interface Fee_estimatorP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP61({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP61Props) {
