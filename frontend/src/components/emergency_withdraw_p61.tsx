...
interface Emergency_withdrawP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP61({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP61Props) {
