...
interface Stake_optimizerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP30({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP30Props) {
