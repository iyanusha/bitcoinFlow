...
interface Auto_compound_uiP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Auto_compound_uiP30({ title = 'Add auto-compound interface', data, onAction }: Auto_compound_uiP30Props) {
