...
interface Vault_comparisonP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP70({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP70Props) {
