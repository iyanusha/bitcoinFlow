...
interface Deposit_historyP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP1({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP1Props) {
