...
interface Portfolio_viewP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP11({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP11Props) {
