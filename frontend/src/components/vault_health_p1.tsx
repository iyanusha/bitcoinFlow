...
interface Vault_healthP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP1({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP1Props) {
