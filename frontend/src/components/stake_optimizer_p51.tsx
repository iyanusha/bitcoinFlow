...
interface Stake_optimizerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP51({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP51Props) {
