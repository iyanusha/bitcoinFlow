...
interface Vault_migrationP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP21({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP21Props) {
