...
interface Deposit_historyP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP40({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP40Props) {
