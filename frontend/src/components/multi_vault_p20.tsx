...
interface Multi_vaultP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP20({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP20Props) {
