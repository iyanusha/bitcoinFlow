...
interface Vault_comparisonP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP40({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP40Props) {
