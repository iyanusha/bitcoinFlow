...
interface Reward_trackerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP21({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP21Props) {
