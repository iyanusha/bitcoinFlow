...
interface Vault_healthP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP10({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP10Props) {
