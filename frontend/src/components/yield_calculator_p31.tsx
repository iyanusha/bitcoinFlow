...
interface Yield_calculatorP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP31({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP31Props) {
