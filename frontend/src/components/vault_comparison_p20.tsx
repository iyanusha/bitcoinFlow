...
interface Vault_comparisonP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP20({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP20Props) {
