...
interface Fee_estimatorP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP30({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP30Props) {
