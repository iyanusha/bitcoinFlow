...
interface Vault_healthP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP21({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP21Props) {
