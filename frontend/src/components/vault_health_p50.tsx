...
interface Vault_healthP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP50({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP50Props) {
