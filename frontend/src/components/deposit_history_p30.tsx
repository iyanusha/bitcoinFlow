...
interface Deposit_historyP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP30({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP30Props) {
