interface Component_docsItemProps { title: string; value: string; description?: string; }

export function Component_docsItem({ title, value, description }: Component_docsItemProps) {
  return (
