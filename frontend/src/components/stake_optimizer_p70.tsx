...
interface Stake_optimizerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP70({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP70Props) {
