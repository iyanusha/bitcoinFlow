...
interface Stx_converterP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP50({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP50Props) {
