interface Contract_tests_v2ItemProps { title: string; value: string; description?: string; }

export function Contract_tests_v2Item({ title, value, description }: Contract_tests_v2ItemProps) {
  return (
