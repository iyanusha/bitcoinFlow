...
interface Vault_comparisonP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP0({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP0Props) {
