...
interface User_preferencesP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP21({ title = 'Add user preferences panel', data, onAction }: User_preferencesP21Props) {
