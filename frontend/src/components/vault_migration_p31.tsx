...
interface Vault_migrationP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP31({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP31Props) {
