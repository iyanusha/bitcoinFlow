...
interface Stake_optimizerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP21({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP21Props) {
