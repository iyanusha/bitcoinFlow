interface Post_conditionsItemProps { title: string; value: string; description?: string; }

export function Post_conditionsItem({ title, value, description }: Post_conditionsItemProps) {
  return (
