...
interface Withdraw_historyP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP40({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP40Props) {
