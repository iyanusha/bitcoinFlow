...
interface Reward_trackerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP30({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP30Props) {
