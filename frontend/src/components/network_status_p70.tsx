...
interface Network_statusP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP70({ title = 'Add network status monitor', data, onAction }: Network_statusP70Props) {
