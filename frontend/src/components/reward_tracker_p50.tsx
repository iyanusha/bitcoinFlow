...
interface Reward_trackerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP50({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP50Props) {
