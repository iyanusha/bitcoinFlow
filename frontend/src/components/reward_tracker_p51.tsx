...
interface Reward_trackerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP51({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP51Props) {
