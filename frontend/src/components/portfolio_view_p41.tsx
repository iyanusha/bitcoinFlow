...
interface Portfolio_viewP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP41({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP41Props) {
