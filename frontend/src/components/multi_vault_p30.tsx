...
interface Multi_vaultP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP30({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP30Props) {
