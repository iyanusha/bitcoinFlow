...
interface Multi_vaultP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP60({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP60Props) {
