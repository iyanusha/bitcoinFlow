...
interface Yield_calculatorP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP11({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP11Props) {
