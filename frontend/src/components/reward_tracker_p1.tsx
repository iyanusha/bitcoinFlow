...
interface Reward_trackerP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP1({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP1Props) {
