...
interface Vault_healthP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP60({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP60Props) {
