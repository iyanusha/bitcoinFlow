...
interface User_preferencesP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP70({ title = 'Add user preferences panel', data, onAction }: User_preferencesP70Props) {
