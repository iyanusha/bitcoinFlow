...
interface Withdraw_historyP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP21({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP21Props) {
