...
interface Reward_trackerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP61({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP61Props) {
