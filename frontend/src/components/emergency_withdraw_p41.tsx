...
interface Emergency_withdrawP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP41({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP41Props) {
