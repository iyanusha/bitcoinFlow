interface Component_testsItemProps { title: string; value: string; description?: string; }

export function Component_testsItem({ title, value, description }: Component_testsItemProps) {
  return (
