...
interface Contract_eventsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Contract_eventsP1({ title = 'Add contract event listener system', data, onAction }: Contract_eventsP1Props) {
