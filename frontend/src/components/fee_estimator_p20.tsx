...
interface Fee_estimatorP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP20({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP20Props) {
