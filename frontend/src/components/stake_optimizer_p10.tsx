...
interface Stake_optimizerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP10({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP10Props) {
