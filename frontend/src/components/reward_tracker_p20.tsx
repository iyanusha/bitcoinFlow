...
interface Reward_trackerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP20({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP20Props) {
