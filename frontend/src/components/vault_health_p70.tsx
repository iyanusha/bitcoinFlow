...
interface Vault_healthP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP70({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP70Props) {
