...
interface Yield_calculatorP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP61({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP61Props) {
