...
interface Deposit_historyP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP51({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP51Props) {
