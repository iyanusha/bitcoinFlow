...
interface User_preferencesP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP10({ title = 'Add user preferences panel', data, onAction }: User_preferencesP10Props) {
