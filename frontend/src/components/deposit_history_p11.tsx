...
interface Deposit_historyP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP11({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP11Props) {
