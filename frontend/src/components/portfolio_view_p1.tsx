...
interface Portfolio_viewP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP1({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP1Props) {
