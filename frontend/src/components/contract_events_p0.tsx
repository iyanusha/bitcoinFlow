...
interface Contract_eventsP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Contract_eventsP0({ title = 'Add contract event listener system', data, onAction }: Contract_eventsP0Props) {
