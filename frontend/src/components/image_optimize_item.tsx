interface Image_optimizeItemProps { title: string; value: string; description?: string; }

export function Image_optimizeItem({ title, value, description }: Image_optimizeItemProps) {
  return (
