...
interface Fee_estimatorP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP41({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP41Props) {
