...
interface User_preferencesP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP0({ title = 'Add user preferences panel', data, onAction }: User_preferencesP0Props) {
