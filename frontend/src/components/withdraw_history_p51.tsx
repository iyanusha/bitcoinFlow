...
interface Withdraw_historyP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP51({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP51Props) {
