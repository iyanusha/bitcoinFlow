...
interface Deposit_historyP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP71({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP71Props) {
