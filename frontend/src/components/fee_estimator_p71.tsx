...
interface Fee_estimatorP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP71({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP71Props) {
