...
interface Emergency_withdrawP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP71({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP71Props) {
