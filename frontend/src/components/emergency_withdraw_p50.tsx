...
interface Emergency_withdrawP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP50({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP50Props) {
