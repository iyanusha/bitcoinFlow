...
interface User_preferencesP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP30({ title = 'Add user preferences panel', data, onAction }: User_preferencesP30Props) {
