...
interface Stx_converterP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP31({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP31Props) {
