interface Stats_pollingItemProps { title: string; value: string; description?: string; }

export function Stats_pollingItem({ title, value, description }: Stats_pollingItemProps) {
  return (
