...
interface User_preferencesP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP20({ title = 'Add user preferences panel', data, onAction }: User_preferencesP20Props) {
