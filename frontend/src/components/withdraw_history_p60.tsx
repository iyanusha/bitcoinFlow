...
interface Withdraw_historyP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP60({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP60Props) {
