...
interface Deposit_historyP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP50({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP50Props) {
