...
interface Network_statusP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP20({ title = 'Add network status monitor', data, onAction }: Network_statusP20Props) {
