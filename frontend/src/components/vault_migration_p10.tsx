...
interface Vault_migrationP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP10({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP10Props) {
