...
interface Vault_analyticsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_analyticsP60({ title = 'Add vault analytics dashboard', data, onAction }: Vault_analyticsP60Props) {
