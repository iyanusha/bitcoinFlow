...
interface Stake_optimizerP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP11({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP11Props) {
