...
interface Multi_vaultP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP31({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP31Props) {
