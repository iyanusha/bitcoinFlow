...
interface Vault_healthP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP40({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP40Props) {
