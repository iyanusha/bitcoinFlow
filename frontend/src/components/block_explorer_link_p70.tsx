...
interface Block_explorer_linkP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Block_explorer_linkP70({ title = 'Add block explorer integration links', data, onAction }: Block_explorer_linkP70Props) {
