...
interface Stx_converterP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP60({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP60Props) {
