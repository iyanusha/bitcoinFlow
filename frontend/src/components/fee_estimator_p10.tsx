...
interface Fee_estimatorP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP10({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP10Props) {
