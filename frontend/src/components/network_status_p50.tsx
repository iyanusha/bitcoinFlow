...
interface Network_statusP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP50({ title = 'Add network status monitor', data, onAction }: Network_statusP50Props) {
