...
interface Stx_converterP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP21({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP21Props) {
