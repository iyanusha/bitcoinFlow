...
interface Reward_trackerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP70({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP70Props) {
