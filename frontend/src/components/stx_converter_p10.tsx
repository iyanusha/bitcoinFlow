...
interface Stx_converterP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP10({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP10Props) {
