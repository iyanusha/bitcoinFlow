...
interface Multi_vaultP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP41({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP41Props) {
