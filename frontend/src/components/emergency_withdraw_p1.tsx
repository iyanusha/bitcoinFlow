...
interface Emergency_withdrawP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP1({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP1Props) {
