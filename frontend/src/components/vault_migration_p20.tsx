...
interface Vault_migrationP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP20({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP20Props) {
