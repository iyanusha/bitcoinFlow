...
interface User_preferencesP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP1({ title = 'Add user preferences panel', data, onAction }: User_preferencesP1Props) {
