...
interface Yield_calculatorP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP30({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP30Props) {
