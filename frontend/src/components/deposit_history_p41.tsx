...
interface Deposit_historyP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP41({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP41Props) {
