...
interface Vault_migrationP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP40({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP40Props) {
