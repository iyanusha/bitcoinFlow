...
interface Yield_calculatorP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP60({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP60Props) {
