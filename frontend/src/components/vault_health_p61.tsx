...
interface Vault_healthP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP61({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP61Props) {
