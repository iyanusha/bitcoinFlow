...
interface Block_explorer_linkP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Block_explorer_linkP11({ title = 'Add block explorer integration links', data, onAction }: Block_explorer_linkP11Props) {
