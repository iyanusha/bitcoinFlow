interface Rewards_calcItemProps { title: string; value: string; description?: string; }

export function Rewards_calcItem({ title, value, description }: Rewards_calcItemProps) {
  return (
