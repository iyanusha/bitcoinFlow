...
interface Portfolio_viewP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP21({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP21Props) {
