...
interface Vault_migrationP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP41({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP41Props) {
