...
interface Network_statusP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP51({ title = 'Add network status monitor', data, onAction }: Network_statusP51Props) {
