...
interface Network_statusP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP60({ title = 'Add network status monitor', data, onAction }: Network_statusP60Props) {
