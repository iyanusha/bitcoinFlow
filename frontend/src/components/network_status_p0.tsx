...
interface Network_statusP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP0({ title = 'Add network status monitor', data, onAction }: Network_statusP0Props) {
