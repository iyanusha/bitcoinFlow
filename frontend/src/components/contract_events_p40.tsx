...
interface Contract_eventsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Contract_eventsP40({ title = 'Add contract event listener system', data, onAction }: Contract_eventsP40Props) {
