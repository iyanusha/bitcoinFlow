...
interface Vault_comparisonP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP21({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP21Props) {
