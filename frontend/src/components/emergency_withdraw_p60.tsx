...
interface Emergency_withdrawP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP60({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP60Props) {
