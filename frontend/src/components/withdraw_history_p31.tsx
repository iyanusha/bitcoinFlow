...
interface Withdraw_historyP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP31({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP31Props) {
