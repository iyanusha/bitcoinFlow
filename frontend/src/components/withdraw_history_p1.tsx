...
interface Withdraw_historyP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP1({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP1Props) {
