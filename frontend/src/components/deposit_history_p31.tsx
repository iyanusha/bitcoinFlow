...
interface Deposit_historyP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP31({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP31Props) {
