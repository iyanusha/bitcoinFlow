...
interface Yield_calculatorP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP21({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP21Props) {
