...
interface Withdraw_historyP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP41({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP41Props) {
