...
interface Vault_migrationP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP60({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP60Props) {
