...
interface Vault_analyticsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_analyticsP20({ title = 'Add vault analytics dashboard', data, onAction }: Vault_analyticsP20Props) {
