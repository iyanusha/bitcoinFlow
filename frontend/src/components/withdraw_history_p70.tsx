...
interface Withdraw_historyP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP70({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP70Props) {
