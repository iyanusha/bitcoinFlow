...
interface Vault_comparisonP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP11({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP11Props) {
