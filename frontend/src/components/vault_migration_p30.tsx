...
interface Vault_migrationP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP30({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP30Props) {
