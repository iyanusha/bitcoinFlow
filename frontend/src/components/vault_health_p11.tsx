...
interface Vault_healthP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP11({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP11Props) {
