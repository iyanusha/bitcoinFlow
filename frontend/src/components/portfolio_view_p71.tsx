...
interface Portfolio_viewP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP71({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP71Props) {
