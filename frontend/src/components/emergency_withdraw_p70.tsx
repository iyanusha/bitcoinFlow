...
interface Emergency_withdrawP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP70({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP70Props) {
