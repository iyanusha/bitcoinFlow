interface Tx_trackingItemProps { title: string; value: string; description?: string; }

export function Tx_trackingItem({ title, value, description }: Tx_trackingItemProps) {
  return (
