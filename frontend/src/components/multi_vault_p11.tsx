...
interface Multi_vaultP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP11({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP11Props) {
