...
interface Vault_healthP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP20({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP20Props) {
