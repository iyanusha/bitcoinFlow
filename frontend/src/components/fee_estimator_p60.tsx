...
interface Fee_estimatorP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP60({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP60Props) {
