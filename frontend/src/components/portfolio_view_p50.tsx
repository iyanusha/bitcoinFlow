...
interface Portfolio_viewP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP50({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP50Props) {
