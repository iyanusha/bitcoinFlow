interface Deposit_confirmItemProps { title: string; value: string; description?: string; }

export function Deposit_confirmItem({ title, value, description }: Deposit_confirmItemProps) {
  return (
