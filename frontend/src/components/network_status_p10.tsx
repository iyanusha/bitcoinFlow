...
interface Network_statusP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP10({ title = 'Add network status monitor', data, onAction }: Network_statusP10Props) {
