...
interface Auto_compound_uiP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Auto_compound_uiP61({ title = 'Add auto-compound interface', data, onAction }: Auto_compound_uiP61Props) {
