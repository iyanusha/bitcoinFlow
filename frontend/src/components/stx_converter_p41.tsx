...
interface Stx_converterP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP41({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP41Props) {
