...
interface Vault_migrationP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP71({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP71Props) {
