interface Flow_token_infoItemProps { title: string; value: string; description?: string; }

export function Flow_token_infoItem({ title, value, description }: Flow_token_infoItemProps) {
  return (
