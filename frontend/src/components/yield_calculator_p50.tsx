...
interface Yield_calculatorP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP50({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP50Props) {
