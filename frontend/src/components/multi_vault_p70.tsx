...
interface Multi_vaultP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP70({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP70Props) {
