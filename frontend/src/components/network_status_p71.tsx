...
interface Network_statusP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP71({ title = 'Add network status monitor', data, onAction }: Network_statusP71Props) {
