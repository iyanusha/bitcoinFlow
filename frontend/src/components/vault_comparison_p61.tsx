...
interface Vault_comparisonP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP61({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP61Props) {
