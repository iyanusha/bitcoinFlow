...
interface Emergency_withdrawP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP31({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP31Props) {
