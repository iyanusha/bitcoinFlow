...
interface Yield_calculatorP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP10({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP10Props) {
