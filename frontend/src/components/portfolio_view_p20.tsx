...
interface Portfolio_viewP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP20({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP20Props) {
