...
interface Vault_migrationP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP51({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP51Props) {
