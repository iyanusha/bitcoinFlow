...
interface Reward_trackerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP60({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP60Props) {
