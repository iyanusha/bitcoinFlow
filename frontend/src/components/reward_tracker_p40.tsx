...
interface Reward_trackerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_trackerP40({ title = 'Add reward tracking dashboard', data, onAction }: Reward_trackerP40Props) {
