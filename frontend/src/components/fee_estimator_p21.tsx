...
interface Fee_estimatorP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP21({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP21Props) {
