interface Modal_dialogsItemProps { title: string; value: string; description?: string; }

export function Modal_dialogsItem({ title, value, description }: Modal_dialogsItemProps) {
  return (
