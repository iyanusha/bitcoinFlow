...
interface Auto_compound_uiP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Auto_compound_uiP40({ title = 'Add auto-compound interface', data, onAction }: Auto_compound_uiP40Props) {
