interface ContributingItemProps { title: string; value: string; description?: string; }

export function ContributingItem({ title, value, description }: ContributingItemProps) {
  return (
