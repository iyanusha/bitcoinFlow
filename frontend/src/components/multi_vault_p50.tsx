...
interface Multi_vaultP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP50({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP50Props) {
