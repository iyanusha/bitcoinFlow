...
interface Vault_healthP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP31({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP31Props) {
