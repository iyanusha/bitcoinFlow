...
interface Contract_eventsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Contract_eventsP60({ title = 'Add contract event listener system', data, onAction }: Contract_eventsP60Props) {
