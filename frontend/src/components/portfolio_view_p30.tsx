...
interface Portfolio_viewP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP30({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP30Props) {
