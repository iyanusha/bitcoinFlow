...
interface Withdraw_historyP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP71({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP71Props) {
