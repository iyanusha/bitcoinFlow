...
interface Withdraw_historyP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP61({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP61Props) {
