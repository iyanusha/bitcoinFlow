...
interface Vault_healthP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_healthP51({ title = 'Add vault health monitoring', data, onAction }: Vault_healthP51Props) {
