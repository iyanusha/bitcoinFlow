...
interface Vault_analyticsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_analyticsP40({ title = 'Add vault analytics dashboard', data, onAction }: Vault_analyticsP40Props) {
