...
interface Emergency_withdrawP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP21({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP21Props) {
