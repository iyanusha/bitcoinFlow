...
interface User_preferencesP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP31({ title = 'Add user preferences panel', data, onAction }: User_preferencesP31Props) {
