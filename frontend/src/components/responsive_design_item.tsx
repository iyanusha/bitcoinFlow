interface Responsive_designItemProps { title: string; value: string; description?: string; }

export function Responsive_designItem({ title, value, description }: Responsive_designItemProps) {
  return (
