...
interface Vault_analyticsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_analyticsP1({ title = 'Add vault analytics dashboard', data, onAction }: Vault_analyticsP1Props) {
