...
interface Multi_vaultP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP40({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP40Props) {
