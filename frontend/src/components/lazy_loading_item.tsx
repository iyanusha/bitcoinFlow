interface Lazy_loadingItemProps { title: string; value: string; description?: string; }

export function Lazy_loadingItem({ title, value, description }: Lazy_loadingItemProps) {
  return (
