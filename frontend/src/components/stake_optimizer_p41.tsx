...
interface Stake_optimizerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP41({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP41Props) {
