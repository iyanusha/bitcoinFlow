...
interface Yield_calculatorP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP41({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP41Props) {
