interface Bundle_analyzeItemProps { title: string; value: string; description?: string; }

export function Bundle_analyzeItem({ title, value, description }: Bundle_analyzeItemProps) {
  return (
