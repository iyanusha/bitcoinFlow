...
interface Vault_comparisonP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP60({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP60Props) {
