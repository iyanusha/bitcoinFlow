interface Code_splittingItemProps { title: string; value: string; description?: string; }

export function Code_splittingItem({ title, value, description }: Code_splittingItemProps) {
  return (
