...
interface Stx_converterP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP20({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP20Props) {
