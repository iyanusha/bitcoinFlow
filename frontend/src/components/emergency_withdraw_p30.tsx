...
interface Emergency_withdrawP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP30({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP30Props) {
