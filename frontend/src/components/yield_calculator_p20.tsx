...
interface Yield_calculatorP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP20({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP20Props) {
