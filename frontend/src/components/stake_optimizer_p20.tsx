...
interface Stake_optimizerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP20({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP20Props) {
