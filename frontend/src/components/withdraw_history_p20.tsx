...
interface Withdraw_historyP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP20({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP20Props) {
