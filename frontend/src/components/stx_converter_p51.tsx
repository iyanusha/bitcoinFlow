...
interface Stx_converterP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP51({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP51Props) {
