...
interface Deposit_historyP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP20({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP20Props) {
