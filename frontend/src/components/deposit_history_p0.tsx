...
interface Deposit_historyP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP0({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP0Props) {
