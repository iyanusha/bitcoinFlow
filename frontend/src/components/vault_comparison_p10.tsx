...
interface Vault_comparisonP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP10({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP10Props) {
