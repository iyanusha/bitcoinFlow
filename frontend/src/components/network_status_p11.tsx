...
interface Network_statusP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP11({ title = 'Add network status monitor', data, onAction }: Network_statusP11Props) {
