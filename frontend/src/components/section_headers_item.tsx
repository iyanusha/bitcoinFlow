interface Section_headersItemProps { title: string; value: string; description?: string; }

export function Section_headersItem({ title, value, description }: Section_headersItemProps) {
  return (
