...
interface User_preferencesP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP50({ title = 'Add user preferences panel', data, onAction }: User_preferencesP50Props) {
