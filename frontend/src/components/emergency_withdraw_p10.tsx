...
interface Emergency_withdrawP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP10({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP10Props) {
