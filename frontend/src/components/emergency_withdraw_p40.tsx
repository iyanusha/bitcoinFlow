...
interface Emergency_withdrawP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP40({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP40Props) {
