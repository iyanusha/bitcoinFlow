interface Network_statusItemProps { title: string; value: string; description?: string; }

export function Network_statusItem({ title, value, description }: Network_statusItemProps) {
  return (
