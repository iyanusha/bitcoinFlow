...
interface Fee_estimatorP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP0({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP0Props) {
