...
interface Contract_eventsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Contract_eventsP20({ title = 'Add contract event listener system', data, onAction }: Contract_eventsP20Props) {
