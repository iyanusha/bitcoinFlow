...
interface Stake_optimizerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP61({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP61Props) {
