...
interface Stx_converterP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP11({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP11Props) {
