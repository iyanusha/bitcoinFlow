...
interface Multi_vaultP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP71({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP71Props) {
