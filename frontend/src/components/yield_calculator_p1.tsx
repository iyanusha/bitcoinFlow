...
interface Yield_calculatorP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP1({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP1Props) {
