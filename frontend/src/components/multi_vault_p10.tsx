...
interface Multi_vaultP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP10({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP10Props) {
