...
interface Emergency_withdrawP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP20({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP20Props) {
