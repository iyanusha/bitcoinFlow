...
interface Vault_migrationP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP50({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP50Props) {
