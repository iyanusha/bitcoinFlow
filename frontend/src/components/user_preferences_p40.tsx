...
interface User_preferencesP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP40({ title = 'Add user preferences panel', data, onAction }: User_preferencesP40Props) {
