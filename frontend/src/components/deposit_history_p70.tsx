...
interface Deposit_historyP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP70({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP70Props) {
