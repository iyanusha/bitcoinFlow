...
interface Yield_calculatorP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP70({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP70Props) {
