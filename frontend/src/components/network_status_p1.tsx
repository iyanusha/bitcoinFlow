...
interface Network_statusP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP1({ title = 'Add network status monitor', data, onAction }: Network_statusP1Props) {
