...
interface Vault_migrationP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_migrationP70({ title = 'Add vault migration wizard', data, onAction }: Vault_migrationP70Props) {
