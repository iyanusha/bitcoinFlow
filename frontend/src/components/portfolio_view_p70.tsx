...
interface Portfolio_viewP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP70({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP70Props) {
