...
interface Vault_analyticsP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_analyticsP0({ title = 'Add vault analytics dashboard', data, onAction }: Vault_analyticsP0Props) {
