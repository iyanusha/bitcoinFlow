...
interface Fee_estimatorP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP1({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP1Props) {
