...
interface Vault_comparisonP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP30({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP30Props) {
