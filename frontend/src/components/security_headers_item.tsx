interface Security_headersItemProps { title: string; value: string; description?: string; }

export function Security_headersItem({ title, value, description }: Security_headersItemProps) {
  return (
