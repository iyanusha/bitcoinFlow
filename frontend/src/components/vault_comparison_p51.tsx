...
interface Vault_comparisonP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Vault_comparisonP51({ title = 'Add vault comparison tools', data, onAction }: Vault_comparisonP51Props) {
