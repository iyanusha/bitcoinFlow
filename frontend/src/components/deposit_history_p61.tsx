...
interface Deposit_historyP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP61({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP61Props) {
