...
interface Deposit_historyP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP60({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP60Props) {
