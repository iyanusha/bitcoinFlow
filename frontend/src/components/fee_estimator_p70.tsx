...
interface Fee_estimatorP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP70({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP70Props) {
