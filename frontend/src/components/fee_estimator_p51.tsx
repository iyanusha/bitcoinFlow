...
interface Fee_estimatorP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP51({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP51Props) {
