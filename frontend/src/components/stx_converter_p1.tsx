...
interface Stx_converterP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP1({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP1Props) {
