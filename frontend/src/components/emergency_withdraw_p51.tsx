...
interface Emergency_withdrawP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Emergency_withdrawP51({ title = 'Add emergency withdrawal flow', data, onAction }: Emergency_withdrawP51Props) {
