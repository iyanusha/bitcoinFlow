...
interface Withdraw_historyP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP10({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP10Props) {
