...
interface User_preferencesP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP60({ title = 'Add user preferences panel', data, onAction }: User_preferencesP60Props) {
