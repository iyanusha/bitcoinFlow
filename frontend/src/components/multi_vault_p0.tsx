...
interface Multi_vaultP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Multi_vaultP0({ title = 'Add multi-vault management', data, onAction }: Multi_vaultP0Props) {
