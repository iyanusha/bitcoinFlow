...
interface User_preferencesP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function User_preferencesP41({ title = 'Add user preferences panel', data, onAction }: User_preferencesP41Props) {
