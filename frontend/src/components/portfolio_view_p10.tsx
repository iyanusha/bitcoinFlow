...
interface Portfolio_viewP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Portfolio_viewP10({ title = 'Add portfolio overview page', data, onAction }: Portfolio_viewP10Props) {
