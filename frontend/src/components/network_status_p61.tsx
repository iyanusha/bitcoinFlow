...
interface Network_statusP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP61({ title = 'Add network status monitor', data, onAction }: Network_statusP61Props) {
