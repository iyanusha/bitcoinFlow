...
interface Network_statusP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP31({ title = 'Add network status monitor', data, onAction }: Network_statusP31Props) {
