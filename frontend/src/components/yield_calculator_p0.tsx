...
interface Yield_calculatorP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Yield_calculatorP0({ title = 'Add yield calculation tools', data, onAction }: Yield_calculatorP0Props) {
