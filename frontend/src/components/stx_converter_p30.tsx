...
interface Stx_converterP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP30({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP30Props) {
