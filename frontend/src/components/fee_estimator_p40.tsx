...
interface Fee_estimatorP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP40({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP40Props) {
