...
interface Stake_optimizerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stake_optimizerP50({ title = 'Add stake optimization tools', data, onAction }: Stake_optimizerP50Props) {
