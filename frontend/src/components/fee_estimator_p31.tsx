...
interface Fee_estimatorP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Fee_estimatorP31({ title = 'Add transaction fee estimator', data, onAction }: Fee_estimatorP31Props) {
