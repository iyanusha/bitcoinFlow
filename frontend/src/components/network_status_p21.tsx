...
interface Network_statusP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_statusP21({ title = 'Add network status monitor', data, onAction }: Network_statusP21Props) {
