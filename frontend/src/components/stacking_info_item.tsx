interface Stacking_infoItemProps { title: string; value: string; description?: string; }

export function Stacking_infoItem({ title, value, description }: Stacking_infoItemProps) {
  return (
