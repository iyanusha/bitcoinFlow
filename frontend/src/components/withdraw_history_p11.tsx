...
interface Withdraw_historyP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Withdraw_historyP11({ title = 'Add withdrawal transaction history', data, onAction }: Withdraw_historyP11Props) {
