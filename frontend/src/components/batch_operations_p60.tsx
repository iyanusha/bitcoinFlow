...
interface Batch_operationsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Batch_operationsP60({ title = 'Add batch operation support', data, onAction }: Batch_operationsP60Props) {
