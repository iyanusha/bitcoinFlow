...
interface Stx_converterP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Stx_converterP40({ title = 'Add STX conversion utilities', data, onAction }: Stx_converterP40Props) {
