...
interface Deposit_historyP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Deposit_historyP21({ title = 'Add deposit transaction history', data, onAction }: Deposit_historyP21Props) {
